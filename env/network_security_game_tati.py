...
class NetworkSecurityEnvironment(object):
    ...
    def __init__(self, task_config_file) -> None:
        ...
        components.ActionType.NoAction.default_success_p, components.ActionType.NoAction.default_detection_p = self.task_config.read_env_action_data('no_action')
    ...
    def get_all_actions(self):
        ...
        # No Action taken
        actions.add(components.Action(components.ActionType.NoAction,{}))
    ...
    def _execute_action(self, current:components.GameState, action:components.Action)-> components.GameState:
        ...
        elif action.type == components.ActionType.NoAction:
            pass
        else:
